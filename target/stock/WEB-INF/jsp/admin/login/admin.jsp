...
<script type="text/javascript">
	$(function() {
	//	var info = "${param.error}";
		<%String info = request.getParameter("error");
...
<body>
	<div class="page-container">
		...
		<form action="user/managerLogin" method="post" id="login_form">
			<div class="msg-error" style="display: none;">
				<img id="errorImg" /> <span><%=info%></span>
			</div>
			<input type="text" id="username" name="username" placeholder="请输入您的用户名！" onfocus="hideError()"/> 
			<input type="password" id="password" name="password" placeholder="请输入您的用户密码！" onfocus="hideError()"/>
			<div>
				<input type="Captcha" class="Captcha" id="Captcha" name="Captcha" placeholder="请输入验证码！" onfocus="hideError()"/> 
				<img src="code" alt="验证码" title="点击更换" id="imageCode" onclick="changeImg();" /> 
				<span id="codeInfo"></span>
			</div>
			<input type="hidden" value="${empty param.backUrl?backUrl:param.backUrl}" name="backUrl">
			<button type="button" class="submit_button" onclick="return toValid()">登录</button>
			<div class="error">
				<span>+</span>
			</div>
		</form>
