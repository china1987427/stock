...
public class KLineCombineChart {
	...
	public static void main(String[] args) {
		...
		TimeSeries daySeries=new TimeSeries("股票行情", Day.class);
		daySeries.add(new Day(20, 8, 2007), 7.15);  
		daySeries.add(new Day(21, 8, 2007), 7.68); 
		daySeries.add(new Day(22, 8, 2007), 7.99); 
		daySeries.add(new Day(23, 8, 2007), 8.11); 
