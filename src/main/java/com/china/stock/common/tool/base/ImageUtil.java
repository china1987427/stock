...
public class ImageUtil {
    private int width = 80;//图片的width
    private int height = 40;//图片的height
    private int codeCount = 4;//图片上显示验证码的个数
    private int xx = 15;
    ...
    public void getCode(HttpServletRequest req, HttpServletResponse resp)
        ...
        Graphics graphic = buffImg.getGraphics();
        // 创建一个随机数生成器类
        ...
        for (int i = 0; i < codeCount; i++) {
            ...
            graphic.drawString(code, (i + 1) * xx, codeY);
