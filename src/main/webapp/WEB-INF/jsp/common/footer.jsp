...
<%-- <%
	String info = request.getSession().getAttribute("indexInfo");
	JSONObject indexInfo = JSON.parseObject(info);
	document.write(indexInfo);
	String shanghai = indexInfo.getString("shanghai");
	String shenzhen = indexInfo.getString("shenzhen");
	String DJI = indexInfo.getString("DJI");
	String IXIC = indexInfo.getString("IXIC");
	String INX = indexInfo.getString("INX");
	String HSI = indexInfo.getString("HSI");
%> --%>
<!DOCTYPE html>
